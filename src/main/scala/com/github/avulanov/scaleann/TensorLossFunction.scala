...
/**
  ...
  */
private[scaleann] trait LossFunction {
  /**
    * Loss function
    *
...
private[scaleann] class SigmoidLayerModelWithSquaredError
...
private[scaleann] class SoftmaxLayerModelWithCrossEntropyLoss extends LayerModel with LossFunction {
...
private[scaleann] class EmptyLayerModelWithSquaredError extends LayerModel with LossFunction {
...
private[scaleann] class SigmoidLayerModelWithCrossEntropyLoss
  extends FunctionalLayerModel(new FunctionalLayer(new SigmoidFunction)) with LossFunction {
