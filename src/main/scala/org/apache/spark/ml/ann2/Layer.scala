...
package org.apache.spark.ml.ann2
 ...
 *
 */
private[ann2] trait Layer extends Serializable {
 ...
 */
private[ann2] trait LayerModel extends Serializable {
 ...
 */
private[ann2] class AffineLayer(val numIn: Int, val numOut: Int) extends Layer {
 ...
 */
private[ann2] class AffineLayerModel private[ann2] (
    val weights: BDV[Double],
 ...
 */
private[ann2] object AffineLayerModel {
 ...
 */
private[ann2] trait ActivationFunction extends Serializable {
 ...
 */
private[ann2] object ApplyInPlace {
 ...
 */
private[ann2] class SigmoidFunction extends ActivationFunction {
 ...
 */
private[ann2] class FunctionalLayer (val activationFunction: ActivationFunction) extends Layer {
 ...
 */
private[ann2] class FunctionalLayerModel private[ann2] (val layer: FunctionalLayer)
  extends LayerModel {
...
/**
 * Trait for the artificial neural network (ANN2) topology properties
 */
private[ann2] trait Topology extends Serializable {
 ...
 */
private[ann2] trait TopologyModel extends Serializable {
 ...
 */
private[ann2] class FeedForwardTopology private(val layers: Array[Layer]) extends Topology {
 ...
 */
private[ann2] object FeedForwardModel {
 ...
 */
private[ann2] class ANNGradient(topology: Topology, dataStacker: DataStacker) extends Gradient {
 ...
 */
private[ann2] class DataStacker(stackSize: Int, inputSize: Int, outputSize: Int)
 ...
 * Simple updater
 */
private[ann2] class ANNUpdater extends Updater {
