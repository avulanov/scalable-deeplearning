 ...
 */
private[ann2] trait LossFunction {
  /**
...
private[ann2] class SigmoidLayerWithSquaredError extends Layer {
...
private[ann2] class SigmoidLayerModelWithSquaredError
...
private[ann2] class SoftmaxLayerWithCrossEntropyLoss extends Layer {
  override val weightSize = 0
  override val inPlace = true
...
private[ann2] class SoftmaxLayerModelWithCrossEntropyLoss extends LayerModel with LossFunction {
