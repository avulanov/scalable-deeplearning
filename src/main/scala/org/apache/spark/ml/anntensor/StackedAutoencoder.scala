...
import com.github.avulanov.scaleann.{EmptyLayerWithSquaredError, FeedForwardTopology, FeedForwardTrainer}
 ...
 */
private[anntensor] trait StackedAutoencoderParams extends Params with HasInputCol with HasOutputCol {
  /**
