...
package org.apache.spark.ml.classification2
...
import org.apache.spark.ml.ann2.{FeedForwardTopology, FeedForwardTrainer}
...
private[classification2] trait MultilayerPerceptronParams extends PredictorParams
...
object MultilayerPerceptronClassifier
  ...
  private[classification2] val LBFGS = "l-bfgs"

  /** String name for "gd" (minibatch gradient descent) solver. */
  private[classification2] val GD = "gd"

  /** Set of solvers that MultilayerPerceptronClassifier supports. */
  private[classification2] val supportedSolvers = Array(LBFGS, GD)
